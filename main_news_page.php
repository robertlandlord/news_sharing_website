...
<html lang="en">
    ...
    <body>
        ...
        if(!isset($_SESSION['loggedin'])||$_SESSION['loggedin']==0){
            ...
            echo "<br><form name='new_user_form' action='http://ec2-13-59-77-129.us-east-2.compute.amazonaws.com/~robertlandlord/module3/story_submission.php'><input type='submit' value='Submit a story'/></form>";
